...
// Set at build time from the public site URL or Vercel's production domain.
const baseURL: string = (process.env.NEXT_PUBLIC_SITE_URL || "http://localhost:3000").replace(/\/$/, "");
